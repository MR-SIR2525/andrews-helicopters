## Ascent and Descent controls
execute as @s at @s if entity @p[r=4,tag=pilot,rx=-61,rxm=-90] run effect @s levitation 1 7 true

execute as @s at @s if entity @p[r=4,tag=pilot,rx=-51,rxm=-60] run effect @s levitation 1 6 true
...
execute as @s at @s if entity @p[r=4,tag=pilot,rx=90,rxm=10] run effect @s slow_falling 1 0 true

## Detect in air for faster speed
execute as @s at @s if block ~ ~-1 ~ air if block ~ ~-6 ~ air run effect @s speed 1 12 true
...
execute as @s at @s run effect @s slow_falling 10000 0 true
